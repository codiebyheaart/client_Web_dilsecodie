...
<meta name="keywords" content="Codeconnected">
<meta name="description" content="Codeconnected by Pankaj Verma">
<meta name="author" content="https://phobostechnologies.com/">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<title>Codeconnected – </title>
...
135deg, #b1d09285 0%, #ffffff 47%, #02515742 100%);" class="ttm-page-title-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12"> 
                                 ...
                                 <div class="">
                                        <form id="subscribe-form" class="newsletter-form" method="post" action="#" data-mailchimp="true">
                                            <div class="mailchimp-inputbox clearfix" id="subscribe-content">
                                                ...
                                                <input type="email" name="email" placeholder="Search Coding article" required="">
